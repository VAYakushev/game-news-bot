...
class VKPoster:
    ...
    def rewrite_with_llm(self, title, description):
        ...
        prompt = f"""Ты — редактор новостного канала про игры. Напиши подробное описание для новости на русском языке.

Заголовок новости: {title}
Краткое описание: {description}

Напиши развёрнутое описание (3-5 предложений), которое:
- Объясняет суть новости подробнее
- Добавляет контекст (дата выхода, подробности, причины)
